      ...
      <div className='midsection bg-black w-full min-h-screen relative overflow-hidden'>
       <Image className=' w-full h-full absolute hidden xl:block' src="/secback.png" alt=""  width={300} height={500}/>
        ...
        <ScrambledText className="scrambled-text-demo leading-loose" radius={100} duration={1.2} speed={0.5} scrambleChars={"kisu"}>
             I'm a dedicated artist with 5.5 years of experience in charcoal and graphite sketch. I specialize in figurative art, character art, fine art, pencil portraiture, and traditional sketching. I prefer working on Meadium surface sheets, ivory sheets, khaki sheets to create expressive, detailed drawings.        
       </ScrambledText>
